...
public class JanusStreamsAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (janusPluginHandle.janusUserDetail.isSelected()) {
...
//            if (janusPluginHandle.remoteStream != null && !janusPluginHandle.janusUserDetail.isSelected()) {
            if (!janusPluginHandle.janusUserDetail.isSelected()) {
                ...
                /*
                 * Check if user video is available or not.
                 * */
//                if (!janusPluginHandle.janusUserDetail.isVideoEnable()) {
...
//                }
                ...
                /*
                 * Configure audio/video layout & configure Audio/Video Icons
                 * */
//                DtoPublisher dtoPublisher = getPublisherFromControlsList(janusPluginHandle.id);
//                if (dtoPublisher != null) {
//                    if (!dtoPublisher.isVideo()) {
//                        configureLayout(rv_surfaceViewRenderer, cl_Renderer_Name, true);
//                    } else {
//                        configureLayout(rv_surfaceViewRenderer, cl_Renderer_Name, false);
//                    }
//
//                    /*
//                     * Configure Video Icon
//                     * */
////                    if (dtoPublisher.isVideo()) {//set simple video icon.
////                        img_Video.setImageResource(R.mipmap.video);
////                    } else {//set crossed video icon
////                        img_Video.setImageResource(R.mipmap.video);
////                    }
//
//                    /*
//                     * Configure Mic Icon
//                     * */
//                    if (dtoPublisher.isAudio()) {//set simple mic icon.
//                        img_Mic.setImageResource(R.mipmap.mic);
//                    } else {//set crossed mic icon
//                        img_Mic.setImageResource(R.drawable.mute);
//                    }
//                }
...
//                if (janusPluginHandle.janusUserDetail.isMicEnable()) {
//                    img_Mic.setImageResource(R.mipmap.mic);
//                } else {
//                    img_Mic.setImageResource(R.drawable.mute);
//                }
